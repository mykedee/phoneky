        ...
        <div className="w-11/12 md:w-9/12 mx-auto my-20">
          ...
          <form className="md:mx-3" onSubmit={handleSubmit}>
            ...
            <div className="mx-3">
              <Link
                to="/forgot-password"
                className="text-slate-700 float-right text-sm"
              >
                Forgot Password?
              </Link>
            </div>
            ...
            <div className="mx-3">
              <button
                className="mt-4 text-base font-semibold p-3 w-full bg-main-btn-color hover:bg-main-btn-hover text-white rounded transition ease-in-out delay-150"
                type="submit"
              >
          ...
          <p className="text-center mt-4 p-2 text-sm text-slate-700">
            ...
            <Link to="/register">
              <span className="text-base font-semibold hover:text-main-btn-hover text-slate-500">
                Sign up
              </span>
            </Link>
          </p>
