  ...
  return (
    <div className="form-area">
      <span className="" onClick={handleShow}>
        <div className="p-2 md:text-base text-sm dark:bg-primary-orange dark:hover:bg-primary-orange-hover bg-primary-green hover:bg-green-700 text-slate-50 rounded cursor-pointer">
          + Add User
        </div>
      </span>
